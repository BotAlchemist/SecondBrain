...
def add_workout():
    ...
    with tab1: # Daily workout
        ...
        i_equipment= st.selectbox("Equipment", ['5kg dumbell'])
        exercise_name_list= ['Biceps curl', 'Squat', 'One Arm row', 'Push up', 'Lateral raise', 'Overhead press', 'French press', 'Crunch', 'Leg raise']
        ...
        with st.form("workout_form"):
            ...
            for i_name in exercise_name_list:
                ...
                no_reps= work2.number_input('Reps', value= 0, step=1,min_value= 0,  max_value= 20, key= i_name)
